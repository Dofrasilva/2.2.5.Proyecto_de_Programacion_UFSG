...
public class EditarActividad extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actividad = (EditText)findViewById(R.id.edtActividad);
        etFecha_Ini = (EditText)findViewById(R.id.edtFechaI);
        etFecha_Fin = (EditText)findViewById(R.id.edtFechaF);
        credito = (EditText)findViewById(R.id.edtCredito);
